...
import { create, getProductList, updateProduct, deleteProduct , searchProduct, image } from './productController';
...
module.exports = (app) => {
    ...
    router.post('/create-new-product', authenticate(), create);
    router.post('/image', authenticate(),  image);
